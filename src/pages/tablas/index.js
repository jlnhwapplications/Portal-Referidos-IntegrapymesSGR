...
import { COLUMNSEXAMPLE } from '@/columns/columnsExample'
            ...
            <PageHeader
                ...
                subtitle={
                    <Typography variant='body2'>
                        Data Grid es una tabla de datos de reacción rápida y ampliable.
                    </Typography>
                }
            />
            <Grid item xs={12}>
                <Table
                    ...
                    name={"Tabla"}
                    addRow={true}
                    // toggle={funcionParaAbrir} aca podes agregar un modar, un sidemodal, o redirigir a una nueva ventana
                />
            </Grid>
