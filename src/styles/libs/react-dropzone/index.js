...
const DropzoneWrapper = styled(Box)(({ theme }) => ({
  '&.dropzone, & .dropzone': {
    ...
    "&:hover": {
      borderColor: theme.palette.primary.main, // Color de hover que se adapta al tema
      backgroundColor: theme.palette.action.hover, // Fondo de hover que se adapta al tema
    },
    '&:focus': {
      outline: 'none'
    },
