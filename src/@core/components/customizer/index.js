    ...
    <div className='customizer'>
      ...
      <Drawer open={open} hideBackdrop anchor='right' variant='persistent'>
        ...
        >
          ...
          <Typography sx={{ color: 'text.secondary' }}>Personalice y obtenga una vista previa en tiempo real</Typography>
          <IconButton
        ...
        <PerfectScrollbar options={{ wheelPropagation: false }}>
          <CustomizerSpacing className='customizer-body'>
            ...
            {/* Color Picker */}
            <div>
              <Typography sx={{ mb: 2.5 }}>Color Primario</Typography>
              <Box sx={{ display: 'flex' }}>
                <ColorBox
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <Typography>AppBar Difuminado</Typography>
              <Switch
                name='appBarBlur'
                checked={appBarBlur}
            ...
            {/* <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              <Typography>Derecha a Izquierda</Typography>
              <Switch
                name='direction'
